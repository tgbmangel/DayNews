...
if __name__=="__main__":
    ...
    #新闻
    add_schedule('send_message_chatroom_news','day','6:45','经济研讨')
    ...
    send_time="6:46"
    chat_room='经济研讨'
    add_week_schedule('send_message_chatroom_lottery','247',send_time,chat_room,'dlt')
    add_week_schedule('send_message_chatroom_lottery','135',send_time,chat_room,'ssq')
    #定时任务一直循环
